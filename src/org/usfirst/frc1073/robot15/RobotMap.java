...
public class RobotMap {
    ...
    public static DigitalInput elevatorelevatorMagClearanceLevel;
    ...
    public static void init() {
        ...
        toteCollectortoteCollectorLeftTalon = new CANTalon(4);
        
        
        toteCollectortoteCollectorRightTalon = new CANTalon(7);
        
        
        toteCollectortoteCollectorSolenoid = new Solenoid(1, 0);
        LiveWindow.addActuator("ToteCollector", "toteCollectorSolenoid", toteCollectortoteCollectorSolenoid);
        ...
        elevatorelevatorMagClearanceLevel = new DigitalInput(1);
        LiveWindow.addSensor("Elevator", "elevatorMagClearanceLevel", elevatorelevatorMagClearanceLevel);
