 ...
 *
 */
public class  DoubleAutoDriveToAutoZone extends Command {

    public DoubleAutoDriveToAutoZone() {
    ...
    protected void initialize() {
    	Robot.elevator.rollersCollect(-0.5);
    	Robot.collectorWrists.close();
    }

    // Called repeatedly when this Command is scheduled to run
    protected void execute() {
    	Robot.driveTrain.move(0.0f, -0.8f, 0.0f);
    }
