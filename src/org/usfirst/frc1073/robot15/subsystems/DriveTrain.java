...
public class DriveTrain extends Subsystem {
    ...
    public final float cubicConstant2 = (float) 0.07;
    //cubicConstant is the ORIGINAL scalar, currently set to cubicConstant2
    ...
    private float cubicScale(float arg){
    	float a;
    	a = (float) (cubicConstant2*arg + (1-cubicConstant2)*Math.pow((double)arg, 3));
    	return a;
    }
