...
public class Elevator extends Subsystem {
    ...
    private enum elevState { FLOOR_0, BETWEEN_0_1, FLOOR_1, BETWEEN_1_2, FLOOR_2, BETWEEN_2_3, FLOOR_3 };
    private enum trigState { NOTHING, UP, DOWN, AT_0, AT_1, AT_2, AT_3 };
    ...
    public void newMove(elevState goToState){
    	...
    	if(!elevatorMagHigh.get()) currentTrigger = trigState.AT_3;
