...
public class OI 
{
    ...
    public OI() {
        ...
        joystickButton2 = new JoystickButton(driver, 4);
        joystickButton2.whileHeld(new ElevatorDownManual());
        elevatorUp = new JoystickButton(driver, 6);
        elevatorUp.whileHeld(new ElevatorUpManual());
