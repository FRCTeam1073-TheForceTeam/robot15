...
public class OI 
{
    ...
    public OI() {
        ...
        SmartDashboard.putData("AutonomousArmOpen", new AutonomousArmOpen());

        SmartDashboard.putData("AutonomousDriveToTote", new AutonomousDriveToTote());

        SmartDashboard.putData("AutonomousArmClose", new AutonomousArmClose());
