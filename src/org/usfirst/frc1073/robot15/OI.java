...
public class OI 
{
    ...
    public JoystickButton clearanceLiftButton;
    ...
    public OI() {
        ...
        clearanceLiftButton = new JoystickButton(driver, 12);
        clearanceLiftButton.whenPressed(new ClearanceLevelToggle());

	    
        // SmartDashboard Buttons
        SmartDashboard.putData("ClearanceLevelToggle", new ClearanceLevelToggle());
