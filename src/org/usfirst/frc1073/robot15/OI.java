...
public class OI 
{
    ...
    public OI() {
        ...
        SmartDashboard.putData("AutonomousToteOpen", new AutonomousToteOpen());

        SmartDashboard.putData("AutonomousMoveToTote", new AutonomousMoveToTote());

        SmartDashboard.putData("AutonomousToteClose", new AutonomousToteClose());

        SmartDashboard.putData("AutonomousToteCollect", new AutonomousToteCollect());

        SmartDashboard.putData("AutonomousBringToteToTop", new AutonomousBringToteToTop());
