...
public class OI {
    ...
    public JoystickButton setCubic; //setCubic button method was added manually, not through RobotBuilder, so everything is added outside
    								//of the autogenerated code so it isn't removed
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        setCubic = new JoystickButton(driver, 3);
        setCubic.whenPressed(new Cubic());
        
        SmartDashboard.putData("Cubic", new Cubic());
    }
